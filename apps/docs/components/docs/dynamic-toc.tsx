...
export function DynamicToc() {
  ...
  useEffect(() => {
    ...
    function buildToc() {
      ...
      // Find all headings generated by MDX (excludes component sub-parts like TreeView.Label that render as h3)
      const headings = Array.from(contentArea.querySelectorAll('h1, h2, h3, h4, h5, h6')).filter(
        (el) => el.id && el.textContent && el.getAttribute('data-mdx-heading') === 'true',
      )
