    ...
    <Timeline.Root>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Description>
            Started implementing core features and setting up the development environment.
          </Timeline.Description>
        </Timeline.Content>
      </Timeline.Item>
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Description>
            Conducted peer review of the implemented features and addressed feedback.
          </Timeline.Description>
        </Timeline.Content>
      </Timeline.Item>
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Description>
            Ran comprehensive tests and deployed to staging environment for review.
          </Timeline.Description>
        </Timeline.Content>
      </Timeline.Item>
    </Timeline.Root>
