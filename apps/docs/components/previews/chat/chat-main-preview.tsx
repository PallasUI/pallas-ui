...
import type { ChatPreviewProps, Message } from './types'

export function ChatMainPreview({ initialMessages = [] }: ChatPreviewProps) {
  ...
  const addMessage = () => {
    ...
    // Simulated network / thinking delay for the docs preview only (ms).
