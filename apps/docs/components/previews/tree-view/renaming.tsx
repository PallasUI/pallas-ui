...
export default function RenamingPreview() {
  return (
    <Stack w="320px">
      {/* Double-click any node to rename it. Press Enter to confirm or Escape to cancel. */}
      <TreeView.Root
        collection={collection as TreeCollection}
        defaultExpandedValue={['src']}
        canRename={() => true}
      >
        <TreeView.Label>Project Files (double-click to rename)</TreeView.Label>
        <TreeView.Tree>
