...
Three visual variants control the hover and selection appearance: `subtle` (default), `outline`, and `ghost`.
...
| `variant` | `'subtle' \| 'outline' \| 'ghost'` | `'subtle'` | Visual style of hover and selection states |
