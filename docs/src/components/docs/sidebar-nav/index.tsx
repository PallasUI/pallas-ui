...
// @ts-ignore
import { allComponents, allGuides, allOverviews } from 'contentlayer/generated'
import Link from 'next/link'
import { usePathname } from 'next/navigation'
import { Item, ItemContent, ItemTrigger, Root } from '~/components/ui/accordian'
import { sortDocs } from '~/lib/sort-docs'

const Accordion = Root
const AccordionItem = Item
const AccordionTrigger = ItemTrigger
const AccordionContent = ItemContent
...
export const SidebarNav = ({ onNavigate }: SidebarNavProps) => {
  ...
  return (
    <Accordion type="multiple" defaultValue={['overview', 'guides', 'components']} asChild>
      <ul>
        <AccordionItem value="overview" asChild>
          <li>
        ...
        <AccordionItem value="guides" asChild>
          <li>
        ...
        <AccordionItem value="components" asChild>
          <li>
